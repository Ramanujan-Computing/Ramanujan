...
def main():
    ...
    layout_path = os.path.join(out_dir, "packed_layout.txt")
    ...
    # Keep every GPU allocation below 100 MiB for 32-bit mobile OpenCL drivers.
    write_csv(f"{out_dir}/wte_1.csv", wte[:8000])
    write_csv(f"{out_dir}/wte_2.csv", wte[8000:16000])
    write_csv(f"{out_dir}/wte_3.csv", wte[16000:24000])
    write_csv(f"{out_dir}/wte_4.csv", wte[24000:])
    ...
    write_csv(f"{out_dir}/lm_head_1.csv", lm_head[:8000])
    write_csv(f"{out_dir}/lm_head_2.csv", lm_head[8000:16000])
    write_csv(f"{out_dir}/lm_head_3.csv", lm_head[16000:24000])
    write_csv(f"{out_dir}/lm_head_4.csv", lm_head[24000:])
    ...
    with open(layout_path, "w", encoding="utf-8") as layout_file:
        layout_file.write(PACKED_LAYOUT_VERSION + "\n")
