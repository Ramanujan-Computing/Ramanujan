...
import in.ramanujan.rule.engine.test.testJson.WhileTestCases;
...
public class WhileCheckpointTest extends SimpleCheckpointTest {
    private ObjectMapper objectMapper = new ObjectMapper();
    private String codeString = WhileTestCases.ruleEngineUnit.replaceAll("\\n", "");
