...
public class AndImpl implements ConditionFunctioning {
    @Override
    public CachedConditionFunctioning process(CommandRE compareWhat, CommandRE compareWith, String processId,
                                              Map<String, RuleEngineInputUnit> mapBetweenIdAndRuleInput, ContextStack contextStack, DebuggerPoint debuggerPoint) {
