...
import in.robinhood.ramanujan.data.db.impl.storageDao.StorageDaoGoogleCloudImpl;
import in.robinhood.ramanujan.db.layer.utils.ConnectionCreator;
import in.robinhood.ramanujan.db.layer.utils.QueryExecutor;
import in.robinhood.ramanujan.middleware.rest.handler.*;
...
public class HttpVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        ((StorageDaoGoogleCloudImpl) storageDao).setContext(context);
