package in.robinhood.ramanujan.data.db.impl.DagElementDao;

import com.fasterxml.jackson.databind.ObjectMapper;
import in.robinhood.ramanujan.data.db.dao.DagElementDao;
import in.robinhood.ramanujan.db.layer.constants.Keys;
import in.robinhood.ramanujan.db.layer.enums.QueryType;
import in.robinhood.ramanujan.db.layer.schema.DagElementMetadata;
import in.robinhood.ramanujan.db.layer.schema.DagElementOrchestratorAsyncIdMapping;
import in.robinhood.ramanujan.db.layer.schema.DagElementRelationShip;
import in.robinhood.ramanujan.db.layer.schema.OrchestratorMiddlewareMapping;
import in.robinhood.ramanujan.db.layer.utils.QueryExecutor;
import in.robinhood.ramanujan.middleware.base.BasicDagElement;
import in.robinhood.ramanujan.middleware.base.DagElement;
import in.robinhood.ramanujan.middleware.base.utils.Splitter;
...
import static in.robinhood.ramanujan.db.layer.constants.Keys.DAG_ELEMENT_ID;
    ...
    public Future<Void> addElement(DagElement dagElement) {
        ...
        try {
            ...
            for(String ruleEngineInputSubString : ruleEngineInputSubStrings) {
                in.robinhood.ramanujan.db.layer.schema.DagElement dagElementSchema = new in.robinhood.ramanujan.db.layer.schema.DagElement();
    ...
    private void populateRuleEngineInDagElement(Future<BasicDagElement> future, BasicDagElement basicDagElement, int maxPart) {
        try {
            ...
            for (int i = 0; i < maxPart; i++) {
                in.robinhood.ramanujan.db.layer.schema.DagElement dagElement = new in.robinhood.ramanujan.db.layer.schema.DagElement();
                ...
                if(handler.succeeded()) {
                    try {
                        ...
                        for (Future queryFuture : futureList) {
                            in.robinhood.ramanujan.db.layer.schema.DagElement dbDagElementInfo = (in.robinhood.ramanujan.db.layer.schema.DagElement)
