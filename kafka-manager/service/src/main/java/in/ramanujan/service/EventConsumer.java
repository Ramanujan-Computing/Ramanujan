...
public class EventConsumer {
    ...
    public Future<Void> consume(final CheckStatusQueueEvent checkStatusQueueEvent) {
        ...
        middlewareClient.callMiddlewareProcessNextElementApi(asyncId, dagElementId, toBeDebugged).setHandler(handler -> {
